...
export default function Error({
  error, // Instance of JavaScript's native Error object.
  reset, // Function to reset the error boundary. When executed, the function will try to re-render the route segment.
}: {
